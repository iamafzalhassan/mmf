...
class AppTheme {
  ...
  static ThemeData get lightTheme {
    ...
    return ThemeData(
        cardTheme: CardThemeData(color: white1, elevation: 1, shadowColor: Colors.black.withOpacity(0.05), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
        ...
        inputDecorationTheme: InputDecorationTheme(
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: gray3)),
            contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16),
            enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: gray3)),
            ...
            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: green2, width: 2)),
            focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: red, width: 2)),
            hintStyle: TextStyle(color: gray4, fontFamily: fontFamily, fontSize: 16),
            labelStyle: TextStyle(color: gray5, fontFamily: fontFamily, fontSize: 16, fontWeight: FontWeight.w400)),
        ...
        textTheme: const TextTheme(
            bodyLarge: TextStyle(color: black, fontFamily: fontFamily, fontSize: 16),
            bodyMedium: TextStyle(color: black, fontFamily: fontFamily, fontSize: 14),
            ...
            titleLarge: TextStyle(color: black, fontFamily: fontFamily, fontSize: 28, fontWeight: FontWeight.w600),
            titleMedium: TextStyle(color: black, fontFamily: fontFamily, fontSize: 18, fontWeight: FontWeight.w600),
