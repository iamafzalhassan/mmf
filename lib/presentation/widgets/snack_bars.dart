...
extension SnackBars on BuildContext {
  ...
  void showSuccessSnackBar(String message) => showMessageSnackBar(backgroundColor: AppTheme.green3, icon: Icons.check_circle_rounded, message: message);
  ...
  void showMessageSnackBar({required Color backgroundColor, required IconData icon, required String message}) => ScaffoldMessenger.of(this).showSnackBar(SnackBar(
      ...
      margin: EdgeInsets.only(bottom: MediaQuery.of(this).size.height - 100, left: 20, right: 20)));
}
