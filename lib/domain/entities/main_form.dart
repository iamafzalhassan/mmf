...
class MainForm {
  ...
  MainForm({required this.address, required this.admissionNo, required this.familiesCount, required this.ownership, required this.refNo, required this.route, required this.familyMembers});
